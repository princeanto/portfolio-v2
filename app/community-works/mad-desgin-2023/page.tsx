...
export default function MadDesign2023() {
    // Progressive image loading state
    const [loaded, setLoaded] = useState(false);
    const [isClient, setIsClient] = useState(false);
    useEffect(() => { setIsClient(true); }, []);

    // Tiny inline placeholder (pure CSS-friendly SVG) pre-encoded; avoids Buffer usage (Edge/Server friendly)
    ...
    return (
        <>
            ...
            <main className="container mx-auto pt-40 pb-0 max-[640px]:pt-32">
                ...
                <h1 className="text-4xl font-bold mt-6 mb-8 max-[640px]:text-3xl">MAD Design 2023</h1>
                <div className="w-full rounded-2xl relative group bg-[#111] min-h-[60vh] max-h-[80vh] flex">
                    {/* Scroll wrapper to keep loader centered relative to viewport-sized box */}
                    ...
                    {isClient && (
                        <Image
                            src="/assets/images/community-works-ui-1.webp"
                            alt="MAD Design 2023"
                            width={1600}
                            height={3200}
                            placeholder="blur"
                    ...
                    {/* Soft gradient edge (optional aesthetic) */}
