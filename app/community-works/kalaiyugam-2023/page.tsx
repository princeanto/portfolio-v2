...
export default function Kalaiyugam2023() {
    ...
    return (
        <>
            ...
            <main className="container mx-auto pt-40 pb-0 max-[640px]:pt-32">
                ...
                <h1 className="text-4xl font-bold mt-6 mb-8 max-[640px]:text-3xl">Kalaiyugam 2023</h1>
                <div className="w-full rounded-2xl relative group bg-[#111] min-h-[60vh] max-h-[80vh] flex">
                    <div className="w-full h-full overflow-auto rounded-2xl">
                        ...
                        {isClient && (
                            <Image
                                src="/assets/images/community-works-ui-4.webp"
                                alt="Kalaiyugam 2023"
                                width={1600}
                                height={3200}
                                placeholder="blur"
